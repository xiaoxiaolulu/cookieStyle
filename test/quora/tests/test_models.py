...
class QAModelsTest(TestCase):
    ...
    def test_question_get_answers(self):
        """获取问题的所有回答"""
        assert self.answer == self.question_two.get_all_answers()[0]
    ...
    def test_question_accepted_answer(self):
        ...
        self.assertFalse(self.question_one.has_correct)
        ...
        self.assertFalse(answer_two.is_accepted)
        self.assertFalse(answer_three.is_accepted)
        self.assertTrue(self.question_one.has_correct)
    ...
    def test_answer_str_(self):
        ...
        assert str(self.answer.question) == "问题2"
